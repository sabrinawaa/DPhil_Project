...
CLEAR_lattice = get_beamline("CLEAR_Beamline_Survey.txt",start, end, P_ref, np.array([19.4, 20.9, 2, 30, 33, 0, 57, 61, 8, 0, 0]))
...
if profile == "intensity":
                        #add vacuum patient position 2500
...
if profile == "intensity":
    ...
    plotter.show_transverse_beam(output_filename, s1_depth, s2_depth, s2_radius,particle= 'e',fov= 30, col=75,n_bins=120)
    plotter.show_transverse_beam(output_filename, s1_depth, s2_depth, s2_radius,particle= 'y',fov=30, col=75,n_bins=120)
